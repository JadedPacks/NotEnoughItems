...
public class NEITransformer implements IClassTransformer {
	...
	public NEITransformer() {
		if(FMLLaunchHandler.side().isClient()) {
			...
			transformer.add(new MethodWriter(ACC_PUBLIC, new ObfMapping("net/minecraft/block/BlockMobSpawner", "func_149689_a", "(Lnet/minecraft/world/World;IIILnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/item/ItemStack;)V"), asmblocks.get("spawnerPlaced")));
			//Make MobSpawnerBaseLogic use getSpawnerWorld when creating new entities
			transformer.add(new MethodReplacer(new ObfMapping("net/minecraft/tileentity/MobSpawnerBaseLogic", "func_98281_h", "()Lnet/minecraft/entity/Entity;"), asmblocks.get("d_spawnerWorld"), asmblocks.get("spawnerWorld")));
		}
		...
		transformer.add(new MethodReplacer(new ObfMapping("net/minecraft/client/renderer/entity/RenderItem", "func_77018_a", "(IIIII)V"), asmblocks.get("d_glintAlphaFix"), asmblocks.get("glintAlphaFix")));
